...
//            we found the min above, but now we got to swap
            swap(data, min, index);
        }
...
//        We start at the index 1 so that we can compare to the left of it, that difference from selection sort
...
//    this is what causing it to be n^2 the code below
